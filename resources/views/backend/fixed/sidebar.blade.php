            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark"  aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Product</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('list.product')}}">Product List</a></li>
                                <li><a href="{{route('add.product')}}">Add Product </a></li>
                                <li><a href="app-ticket.html">Edit Product</a></li>
                                
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">Categories</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{route('add.category')}}">Add Category</a></li>
                                <li><a href="{{route('list.category')}}">Category List</a></li>
                                <li><a href="app-compose.html">Edit Category</a></li>
                            </ul>
                        </li>
